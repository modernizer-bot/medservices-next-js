  ...
  <header id="header" className="header">
    ...
    <div className="wsmainfull menu clearfix">
      <div className="wsmainwp clearfix">
        ...
        <div className="desktoplogo"><a href="demo-1.html"><img src="images/logo.png" width={180} height={40} alt="header-logo" /></a></div>
        {/* MAIN MENU */}
          ...
          <div className="form-holder mb-40">
            <form name="contactForm" className="row contact-form">
              ...
              <div id="input-message" className="col-lg-12 input-message">
                <textarea className="form-control message" name="message" rows={6} placeholder="Your Message ..." required defaultValue={""} />
              </div> 
              {/* Contact Form Button */}
