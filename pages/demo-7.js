      ...
      <div className="container">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-5 col-xl-6">
            <div className="desktoplogo"><a href="#hero-7"><img src="images/logo.png" width={180} height={40} alt="header-logo" /></a></div>
          </div>
          {/* WIDGETS */}
              ...
              <div className="row">
                <div className="col-sm-9 col-md-8 col-lg-7 col-xl-6">
                  <div className="caption-txt">
                    ...
                    <h2 className="steelblue-color">Healthy smile you deserve</h2>
                    {/* CONTENT BOX #1 */}
                    <div className="box-list">							
                      <div className="box-list-icon"><i className="fas fa-genderless" /></div>
                      <p className="p-md">Fringilla risus nec, luctus mauris auctor purus sapien 
                    ...
                    <div className="box-list">	
                      <div className="box-list-icon"><i className="fas fa-genderless" /></div>
                      <p className="p-md">Nemo ipsam egestas volute turpis dolores luctus aliquam 
            ...
            <div className="container">
              <div className="row">
                <div className="col-sm-9 col-md-8 col-lg-7 col-xl-6">
                  <div className="caption-txt">
                    {/* Title */}
                    <h5 className="blue-color">Friendly, caring dental services</h5>
                    <h2 className="steelblue-color">High-class professionals</h2>
                    {/* Text */}
                    <p className="p-md">Feugiat primis ligula risus auctor egestas augue mauri viverra
                    ...
                    {/* Button */}
                    <a href="all-doctors.html" className="btn btn-blue blue-hover">Meet the Doctors</a>
                  </div>	
                </div>
              </div>  {/* End row */}
            </div>  {/* End container */}
            ...
            <div className="container">
              <div className="row">
                <div className="col-sm-9 col-md-8 col-lg-7 col-xl-6">
                  <div className="caption-txt">
                    {/* Title */}
                    <h5 className="blue-color">Straighter Teeth...Healthier Smile!</h5>
                    <h2 className="steelblue-color">We create radiant smiles</h2>
                    {/* Option Box #1 */}
                    <div className="box-list">							
                      <div className="box-list-icon blue-color"><i className="fas fa-angle-double-right" /></div>
                      <p className="p-md">Fringilla risus nec, luctus mauris orci auctor purus euismod 
                    ...
                    <div className="box-list mb-15">	
                      <div className="box-list-icon blue-color"><i className="fas fa-angle-double-right" /></div>
                      <p className="p-md">Feugiat primis ultrice in ligula risus auctor tempus feugiat 
                        impedit dolores ut aliquam quaerat sodales
                      </p>		
                    </div>
                    {/* Button */}
                    <a href="who-we-are.html" className="btn btn-blue blue-hover">Discover More</a>
                  </div>
                </div>
              </div>  {/* End row */}
            </div>  {/* End container */}
      ...
      <div className="row d-flex align-items-center">
        ...
        <div className="col-lg-6">
          <div className="about-img text-center wow fadeInUp" data-wow-delay="0.6s">
            <img className="img-fluid" src="images/image-08.png" alt="about-image" />
          </div>
        </div>
        {/* TEXT BLOCK */}	
        <div className="col-lg-6">
          <div className="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
            ...
            {/* Title */}
            <h3 className="h3-md steelblue-color">Complete Dental Solutions in One Place</h3>
            {/* Text */}
    ...
    <div className="container">
      ...
      <div className="row">	
        <div className="col-lg-10 offset-lg-1 section-title">		
          {/* Title 	*/}	
          <h3 className="h3-md steelblue-color">Dentistry is Our Profession</h3>	
          {/* Text */}
      ...
      <div className="row">
        ...
        <div className="col-md-6 col-lg-3">
          <div className="sbox-4 wow fadeInUp" data-wow-delay="0.4s">
            {/* Image */}
            <img className="img-fluid" src="images/general_dentistry_800x600.jpg" alt="content-image" />	
            {/* Text */}
            <div className="sbox-4-txt">
              <h5 className="h5-md steelblue-color"><a href="single-service.html">General Dentistry</a></h5>
        ...
        <div className="col-md-6 col-lg-3">
          <div className="sbox-4 wow fadeInUp" data-wow-delay="0.6s">
            {/* Image */}
            <img className="img-fluid" src="images/kids_dentistry_800x600.jpg" alt="content-image" />	
            {/* Text */}
            <div className="sbox-4-txt">
              <h5 className="h5-md steelblue-color"><a href="single-service.html">Children's Dentistry</a></h5>
              <p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
                at pretium feugiat dolor integer
              </p>
            </div>							
        ...
        <div className="col-md-6 col-lg-3">
          <div className="sbox-4 wow fadeInUp" data-wow-delay="0.8s">
            {/* Image */}
            <img className="img-fluid" src="images/cosmetic_dentistry_800x600.jpg" alt="content-image" />	
            {/* Text */}
            <div className="sbox-4-txt">
              <h5 className="h5-md steelblue-color"><a href="single-service.html">Cosmetic Services</a></h5>
              <p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
                at pretium feugiat dolor integer
              </p>
            </div>
        ...
        <div className="col-md-6 col-lg-3">
          <div className="sbox-4 wow fadeInUp" data-wow-delay="1s">
            {/* Image */}
            <img className="img-fluid" src="images/dental_emergency_800x600.jpg" alt="content-image" />	
            {/* Text */}
            <div className="sbox-4-txt">
              <h5 className="h5-md steelblue-color"><a href="single-service.html">Dental Emergency</a></h5>
              <p>Porta semper lacus cursus, feugiat primis ultrice in ligula risus auctor
                at pretium feugiat dolor integer
              </p>
            </div>					
      ...
      <div className="row d-flex align-items-center">
        ...
        <div className="col-md-6 col-lg-4">
          ...
          <div className="sbox-6 pr-30 text-right wow fadeInRight" data-wow-delay="0.4s">
            ...
            <p>Semper a augue suscipit, luctus neque purus ipsum neque dolor primis libero tempus</p>
          </div>
          {/* SERVICE BOX #2 */}	
          <div className="sbox-6 pr-30 mr-30 text-right wow fadeInRight" data-wow-delay="0.6s">							
            {/* Text */}
            <h5 className="h5-sm">Dental Checkups</h5>
            <p>Semper a augue suscipit, luctus neque purus ipsum a dolor primis tempus</p>
          </div>	
          {/* SERVICE BOX #2 */}	
  ...
  <section id="services-2" className="wide-70 services-section division">
    <div className="container">
      ...
      <div className="row">	
        <div className="col-lg-10 offset-lg-1 section-title">		
          {/* Title 	*/}	
          <h3 className="h3-md steelblue-color">We Create the Healthy Smiles</h3>	
          {/* Text */}
          <p>Aliquam a augue suscipit, luctus neque purus ipsum neque dolor primis libero at tempus, 
            blandit posuere ligula varius congue cursus porta feugiat
          </p>
          ...
          <div className="sbox-2 wow fadeInUp" data-wow-delay="0.4s">
            <a href="department-single.html">	
              ...
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/braces.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="0.6s">
            <a href="department-single.html">	
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/implant.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="0.8s">
            <a href="department-single.html">	
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/broken.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="1s">
            <a href="department-single.html">	
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/calculus.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="0.4s">
            <a href="department-single.html">	
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/equipment.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="0.6s">
            <a href="department-single.html">	
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/clean.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="0.8s">
            <a href="department-single.html">	
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/anesthetic.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-sm-6 col-lg-3">
          <div className="sbox-2 wow fadeInUp" data-wow-delay="1s">
            <a href="department-single.html">		
              {/* Icon  */}
              <div className="sbox-2-icon">
                <img className="img-80" src="images/icons/caries.png" alt="service-icon" />
              </div>
              {/* Title */}
        ...
        <div className="col-lg-6">
          <div className="video-preview mb-40 text-center wow fadeInUp" data-wow-delay="0.6s">
            ...
            <a className="video-popup1" href="https://www.youtube.com/embed/SZEflIVnhH8">
              ...
              {/* Preview */}	
              <img className="img-fluid" src="images/video-2.png" alt="video-photo" />
            </a>
          </div>
        </div>	{/* END VIDEO LINK */}
        {/* VIDEO TEXT */}
      ...
      <div className="row pricing-row">
        ...
        <div className="col-lg-4">
          <div className="pricing-table icon-xl">	
            ...
            <div className="pricing-plan">									
              ...
              <span className="price steelblue-color">34</span>
        ...
        <div className="col-lg-4">
          <div className="pricing-table icon-xl">
            ...
            <div className="pricing-plan">							
              <sup className="steelblue-color">$</sup>								
              <span className="price steelblue-color">49</span>
              <p className="p-md">monthly</p>
            </div>	
            {/* Pricing Plan Features  */}
            <ul className="features">
        ...
        <div className="col-lg-4">
          <div className="pricing-table icon-xl">	
            ...
            <div className="pricing-plan">								
              <sup className="steelblue-color">$</sup>								
              <span className="price steelblue-color">85</span>
              <p className="p-md">monthly</p>
            </div>
            {/* Pricing Plan Features  */}
            <ul className="features">
      ...
      <div className="row">
        <div className="col-md-12 text-center">
          <div className="all-posts-btn mb-40 wow fadeInUp" data-wow-delay="1s">
            <a href="blog-listing.html" className="btn btn-blue blue-hover">Read More Posts</a>
          </div>
        </div>
      </div>
    </div>	   {/* End container */}		
